...
- [x] 1.1 Write property test for historical data preservation
  - **Property 2: Historical data preservation**
  - **Validates: Requirements 1.3**

- [x] 1.2 Write property test for pengembalian metadata completeness
...
- [x] 2.1 Write property test for pengembalian zeros all simpanan
  - **Property 1: Pengembalian zeros all simpanan balances**
  - **Validates: Requirements 1.1, 1.2**

- [x] 2.2 Write property test for journal entries creation
  - **Property 7: Journal entries for pengembalian**
  - **Validates: Requirements 4.1, 4.2, 4.3**

- [x] 2.3 Write property test for double-entry balance
  - **Property 8: Double-entry balance**
  - **Validates: Requirements 4.4**

- [x] 2.4 Write property test for pengembalian references journal
...
- [x] 6.1 Write property test for transaction validation blocks keluar
  - **Property 14: Transaction validation blocks anggota keluar**
  - **Validates: Requirements 6.1, 6.2, 6.3, 6.4, 6.5**

- [x] 7. Integrate validation ke semua transaksi
...
- [x] 8. Implement surat pengunduran diri generator
...
- [x] 8.1 Write property test for surat contains anggota identity
  - **Property 15: Surat contains anggota identity**
  - **Validates: Requirements 7.2**

- [x] 8.2 Write property test for surat contains exit details
  - **Property 16: Surat contains exit details**
  - **Validates: Requirements 7.3**

- [x] 8.3 Write property test for surat contains pengembalian breakdown
  - **Property 17: Surat contains pengembalian breakdown**
  - **Validates: Requirements 7.4**

- [x] 8.4 Write property test for surat contains payment details
  - **Property 18: Surat contains payment details**
  - **Validates: Requirements 7.5**

- [x] 8.5 Write property test for surat contains koperasi branding
  - **Property 19: Surat contains koperasi branding**
  - **Validates: Requirements 7.6**

- [x] 8.6 Write property test for surat contains signature areas
...
- [x] 10.1 Write property test for rollback preserves data
  - **Property 21: Rollback on error preserves data**
  - **Validates: Requirements 8.1, 8.2, 8.3**

- [x] 10.2 Write property test for failed pengembalian audit log
